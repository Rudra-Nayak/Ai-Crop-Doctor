...
| POST | `/api/voice/synthesize` | Text-to-speech (Groq Orpheus) |
...
│   ├── api/                  # Route handlers
│   ├── agent/                # CrewAI diagnostic agent + tools
│   ├── services/             # Vision, speech, RAG services
...
├── frontend/                 # React/Next.js (Phase 12)
├── requirements.txt
└── .env.example
```
